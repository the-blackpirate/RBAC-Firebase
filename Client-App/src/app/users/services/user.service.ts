...
export interface CreateUserRequest { displayName: string; password: string; email: string; role: string; }
...
export class UserService {
  ...
  private baseUrl = 'https://us-central1-rbac-11.cloudfunctions.net/api/users';
